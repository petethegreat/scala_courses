...
For epressions take the form \lstinline| for (s) yield e |, where $s$ is \textem{sequence of generatprs and filters} and e is an expression that returns a value for each iteration.
